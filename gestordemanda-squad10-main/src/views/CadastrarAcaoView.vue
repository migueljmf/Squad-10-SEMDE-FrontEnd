  ...
  <section class="create-page">
    <div class="create-card">
      <aside class="create-card__info">
        <span class="create-card__badge">Nova acao</span>
        <h1>Cadastro de acao</h1>
        <p>Planeje cada iniciativa com clareza, destacando objetivo, responsaveis e status.</p>
        <ul class="info-list">
          <li>Sinalize o objetivo e o impacto esperado da acao.</li>
          <li>Defina responsaveis, contatos e local de execucao.</li>
          <li>Atualize o status sempre que uma etapa for concluida.</li>
        </ul>
      </aside>

      <form class="create-form" @submit.prevent="salvarAcao">
        <div class="form-section">
          <header class="form-section__header">
            <h2 class="form-section__title">Detalhes principais</h2>
            <p class="form-section__hint">Essas informacoes aparecem em todas as telas de acompanhamento.</p>
          </header>
          <div class="field-grid">
            <label class="field field--full" for="titulo">
              <span>Titulo da acao</span>
              <input id="titulo" v-model="titulo" type="text" placeholder="Ex.: Mutirao de limpeza da praca central" required />
            </label>
            <label class="field" for="data">
              <span>Data da acao</span>
        ...
        <div class="form-section">
          <header class="form-section__header">
            ...
            <p class="form-section__hint">Resuma objetivos, entregas e informacoes uteis para a equipe.</p>
          </header>
          <label class="field field--full" for="descricao">
            ...
            <textarea
              id="descricao"
              v-model="descricao"
              placeholder="Explique o objetivo, o publico envolvido e os principais passos"
              required
            ></textarea>
          </label>
        </div>
        ...
        <div class="form-section">
          <header class="form-section__header">
            <h2 class="form-section__title">Responsaveis & logistica</h2>
            <p class="form-section__hint">Inclua os contatos para que a equipe possa agir rapidamente.</p>
          </header>
          <div class="field-grid">
            <label class="field" for="responsavel">
              <span>Responsavel / solicitante</span>
              <input id="responsavel" v-model="solicitante" type="text" placeholder="Quem lidera a acao?" />
            </label>
            <label class="field" for="contato">
              <span>Contato</span>
              <input id="contato" v-model="contato" type="text" placeholder="E-mail ou telefone" />
            </label>
            <label class="field field--full" for="local">
              <span>Local de realizacao</span>
              <input id="local" v-model="local" type="text" placeholder="Informe endereco, ponto de referencia ou bairro" />
            </label>
          </div>
        </div>
        ...
        <footer class="form-footer">
          ...
          <button type="submit" class="btn btn-primary">Salvar acao</button>
        </footer>
      </form>
    </div>
  </section>
